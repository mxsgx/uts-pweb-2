...
<body>
    <div class="container mt-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 gap-4">
            <h2 class="mb-0">Data Mata Kuliah</h2>
            <a class="btn btn-success" href="<?= url('/mata-kuliah/create.php'); ?>" role="button">Tambah</a>
        </div>
                    ...
                    <?php while ($mata_kuliah = $data->fetch_assoc()) { ?>
                        <tr>
                            ...
                            <td class="d-flex gap-2">
                                ...
                                <a href="<?= url('/mata-kuliah/edit.php?id=' . $mata_kuliah['id_mk']) ?>">Edit</a>
                                <a href="<?= url('/mata-kuliah/delete.php?id=' . $mata_kuliah['id_mk']) ?>" class="text-danger">Hapus</a>
                            </td>
                        </tr>
                    <?php } ?>
                <?php } else { ?>
